...
def verified_call(directory,p,*,imported=False):
    ...
    if imported:
        ...
        if raw!=value:
            if (directory/'stoica-c-repair.json').exists():
                from research_factory.signal_desk_stoica_c_recovery import recover
                expected,repair_proof=recover(raw,p);receipt_name='stoica-c-repair.json';proof['reviewed_stoica_c_repair']=True
            elif (directory/'flattened-b-repair.json').exists():
                from research_factory.signal_desk_flattened_b_recovery import recover
                expected,repair_proof=recover(raw,p);receipt_name='flattened-b-repair.json';proof['reviewed_flattened_b_repair']=True
            elif (directory/'flattened-context-repair.json').exists():
                ...
                from research_factory.signal_desk_tsmc_audit_recovery import recover
                expected,repair_proof=recover(raw,p);receipt_name='tsmc-audit-repair.json';proof['reviewed_tsmc_audit_repair']=True
            ...
            elif (directory/'flattened-audit-repair.json').exists():
                from research_factory.signal_desk_flattened_audit_recovery import recover
                expected,repair_proof=recover(raw,p);receipt_name='flattened-audit-repair.json';proof['reviewed_flattened_audit_repair']=True
            ...
            elif (directory/'tsmc-c-repair.json').exists():
                from research_factory.signal_desk_tsmc_c_recovery import recover
                expected,repair_proof=recover(raw,p);receipt_name='tsmc-c-repair.json';proof['reviewed_tsmc_c_repair']=True
            elif (directory/'ai-governance-audit-context-repair.json').exists():
                from research_factory.signal_desk_ai_governance_audit_context_recovery import recover
                expected,repair_proof=recover(raw,p);receipt_name='ai-governance-audit-context-repair.json';proof['reviewed_governance_audit_context_repair']=True
            elif (directory/'ai-governance-audit-repair.json').exists():
                from research_factory.signal_desk_ai_governance_audit_recovery import recover
                expected,repair_proof=recover(raw,p);receipt_name='ai-governance-audit-repair.json';proof['reviewed_governance_audit_repair']=True
            elif (directory/'stoica-repair.json').exists():
