...
from research_factory import app_server_canonical_v31_nested_ledger_quality_runtime as quality
...
def test_partial_ab_attempt_terminalizes_waiting_without_replay(
    ...
    assert receipt["terminal_reason"] == (
        "epoch35_partial_or_interrupted_ab_ba_preserved_without_replay"
    )
...
def test_live_default_root_rejects_injected_client_or_runner() -> None:
    ...
    with pytest.raises(quality.Epoch35QualityError, match="forbids injected"):
