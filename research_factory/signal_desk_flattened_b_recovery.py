...
def recover(original, packet):
    ...
    from scripts import pif_signal_desk_flattened_b_surface_review as final_review
    ...
    final_id=baseline['events'][3]['event_id']
    ...
    restored['events'][3]['claim_text']=fixed['events'][3]['claim_text']
